...
def main():
    ...
    pygame.display.set_mode((FRAME_SIZE_X, FRAME_SIZE_Y), pygame.RESIZABLE)
    ...
    while True:
        ...
        while choice == "Start Game" or choice == "Play Again":
            ...
            choice = game_loop(game_window, difficulty, color)
            if choice == "Quit":
                pygame.mixer.music.stop()  # Dừng nhạc trước khi thoát
                pygame.quit()
                sys.exit()
